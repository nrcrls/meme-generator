  ...
  return (
    <main class="mt-7 px-4">
      <div className="grid grid-cols-2 gap-4 md:mx-48 lg:mx-80">
        ...
        <button className="w-full border-0 p-2 bg-red-400 text-white hover:bg-red-300 col-span-2 font-space text-lg font-semibold tracking-wider rounded">Get a new meme image</button>
      </div>
    </main>
  );
}
